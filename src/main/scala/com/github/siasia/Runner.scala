...
object Runner {
  ...
  def guessRunner(loader: ClassLoader, rs: Seq[String]): Runner = rs match {
    ...
    case Seq(runner, rest@_*) =>
      try {
        val selectedRunner = loadRunner(runner, loader)
        selectedRunner
      }
      catch {
...
trait Runner {
  ...
  def setLoader(loader: ClassLoader) {
    this.loader = loader
  }
...
class LoggerBase(delegate: AbstractLogger) {
  ...
  def ignore(th: Throwable) {
    delegate.trace(th)
  }

  def info(th: Throwable) {
    delegate.trace(th)
  }
  ...
  def info(msg: String, arg0: AnyRef, arg1: AnyRef) {
    delegate.info(format(msg, arg0, arg1))
  }

  def debug(msg: String, arg0: AnyRef, arg1: AnyRef) {
    delegate.debug(format(msg, arg0, arg1))
  }

  def warn(msg: String, arg0: AnyRef, arg1: AnyRef) {
    delegate.warn(format(msg, arg0, arg1))
  }

  def info(msg: String, args: AnyRef*) {
    delegate.info(format(msg, args: _*))
  }

  def debug(msg: String, args: AnyRef*) {
    delegate.debug(format(msg, args: _*))
  }

  def warn(msg: String, args: AnyRef*) {
    delegate.warn(format(msg, args: _*))
  }
  ...
  private def format(msg: String, args: AnyRef*) = {
    ...
    pieces.zip(argStrs).foldLeft(new StringBuilder) {
      (sb, pair) =>
